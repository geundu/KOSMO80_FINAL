			...
			<ul class="nav navbar-nav">
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">시험등록</li>
					</ol>
...
<div class="d-flex justify-content-center">
	<div class="container">
			...
			<div class="btn-group mb-3" style="text-align: center;">
				<div class="btn-group" style="width: auto;">
					<select class="custom-select" style="width: auto;">
						<option>시험요일 : 선택된 요일</option>
					</select> <select class="custom-select"
						style="width: auto; margin-left: 5%;">
						<option>시작시간 : 선택된 시작시간</option>
					</select> <select class="custom-select"
						style="width: auto; margin-left: 5%;">
						<option>종료시간 : 선택된 종료시간 </option>
					</select>
				</div>
			</div>
		</div>
		...
		<div class="screen3"
			style="width: 100%; height: 10%; background-color:; padding-bottom:10px;">
			<div class="col text-center">
				<!-- <a href="#" button type="button" class="btn  btn-primary mr-5">파일 첨부</a> -->
				<div class="custom-file" style="width: 500px; padding-bottom:10px;">
					<input type="file" class="custom-file-input" id="customFile">

					<label class="custom-file-label" for="customFile"> 주관식문제  </label>
				</div>
			</div>
		</div>
		</div>
		<div class="screen4"
			style="width: 100%; height: auto%; background-color:;">
			<div class="col text-center">
				<button class="btn btn-primary mr-5">시험 등록</button>
				<button class="btn btn-primary">등록 취소</button>
			</div>
		</div>
	</div>
</div>
